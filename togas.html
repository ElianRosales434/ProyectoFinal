...
<body>
    ...
    <div class="container">
        ...
        <div class="col-md-6">
            <!-- Para guardar los datos asegurence de ponerle el mismo nombre guardarT a la función en el archivo-->
            <form id="gownForm" onsubmit="guardarT(); return false;">
                <input type="text" id="CarnetT" class="form-control" placeholder="No. de Carnet" required>
            ...
            <table class="table table-dark table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Tamaño de la Toga</th>
                        <th>Fecha de Entrega</th>
                        <th>Fecha de Devolución</th>
                    </tr>
                </thead>
                <tbody id="TablaTogas"></tbody>
            </table>
